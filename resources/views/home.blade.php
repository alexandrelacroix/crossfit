<x-app-layout>
    <div class="bg_img w-full h-screen lg:h-[120vh] hidden md:block opacity-90 blur-[1px]" style="background-image:url('{{ Storage::url('images/header.jpg') }}');"></div>
    <div class="bg_img w-full h-screen lg:h-[120vh] block md:hidden opacity-90 blur-[1px]" style="background-image:url('{{ Storage::url('images/header_2.jpg') }}');"></div>

    <section class="min-h-screen grid content-center py-6 relative">
        <img src="{{ Storage::url('images/header_shadow.png') }}" class="shadow_bg">
        <x-app.container class="text-creme">
            <div class="relative z-20 drop-shadow-lg mt-10 text-center sm:text-left">
                ...
                <div class="py-8 flex flex-wrap items-center justify-center sm:justify-left mt-3">
                    <x-app.talk class="mr-4">Déja convaincu ?</x-app.talk>
                    <img src="{{ Storage::url('images/arrow.png') }}" alt="" class="flex-none w-7 mr-4 relative -top-3 hidden sm:block">
    ...
    <section class="min-h-screen grid content-center py-6 relative">
        <x-app.container class="text-creme py-40">
            <div class="xl:flex">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3 gap-3">
                    <div class="col-span-1 border-l border-creme py-6 pl-10 pr-6 lg:pr-16">
    ...
    <section class="min-h-screen grid content-center py-6 relative">
        <img src="{{ Storage::url('images/purple_bg.jpg') }}" class="purple_bg opacity-90 blur-[1.5px]">
        <x-app.container class="-skew-y-6 text-center">
            ...
            <img src="{{ Storage::url('images/logo.svg') }}" alt="" class="inline-block relative z-20 w-11 md:w-12 lg:w-16 xl:w-20 skew-y-6 -top-6">
        </x-app.container>
    </section>
    ...
    <section class="min-h-screen grid content-center py-6 relative">
        <x-app.container>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-7 lg:gap-14 mt-4 lg:mt-16 pr-0 xl:pr-16 items-stretch">
                <div class="col-span-1 sm:col-span-2 xl:col-span-1 bg-creme px-10 py-6 lg:px-14 lg:py-8">
                ...
                <div class="col-span-1 bg-creme px-10 py-6 sm:px-6 sm:py-4 lg:px-10 lg:py-8 text-left sm:text-right relative ">
                    ...
                    <img src="{{ Storage::url('images/mike.png') }}" alt="" class="absolute bottom-0 select-none z-20 w-[40%] xl:w-3/5 -left-10 hidden md:inline-block">
                </div>
                <div class="col-span-1 bg-creme px-10 py-6 sm:px-6 sm:py-4 lg:px-10 lg:py-8 text-left relative">
                    ...
                    <img src="{{ Storage::url('images/gerome.png') }}" alt="" class="absolute bottom-0 select-none z-20 w-[50%] xl:w-[72%] -right-11 hidden md:inline-block ">
                </div>
            </div>
        </x-app.container>
    </section>
